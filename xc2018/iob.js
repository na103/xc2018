...
class Iob {
   ...
   * Confusingly, HB.C:PAD43.I, HF.X:PAD34.O, HE.D:PAD37.I, AA.A:PAD1.I, AF.A:PAD11.K.
...
"|col.K.io2:row.?.local.1", "|col.K.io2:row.?.local.4", "|col.K.io2:row.?.long.1",];
        // Annoying special case. The X and Y connections are to e.g. AJ while everything else is in the BJ tile.
        let prevRow = String.fromCharCode(tile.charCodeAt(0) - 1);
        o.push("col.K.io2:" + prevRow + "J.B:" + pad + ".O:" + prevRow + "J.X");
        o.push("col.K.io2:" + prevRow + "J.Y:" + pad + ".O:" + prevRow + "J.Y");
        if (this.muxt & 1) {
          this.tmode = "TRI";
      ...
      } else if (direction == "bottomright" && tile == "KK") { // P53
        this.W = 20;
        this.H = 12;
        xoff = -4;
        yoff = -16
...
"",
      ...
      } else if (direction == "bottomleft" && tile == "KA") { // P33
        this.W = 20;
        this.H = 12;
        xoff = -8;
        yoff = -16
